...
const PROJECT_DEADLINE_REMINDER_TEMPLATE = `
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
  <div style="background: linear-gradient(to right, #E53935, #C62828); padding: 20px; text-align: center;">
    <h1 style="color: white; margin: 0;">Deadline Reminder</h1>
  </div>
  <div style="background-color: #f9f9f9; padding: 20px; border-radius: 0 0 5px 5px; box-shadow: 0 2px 5px rgba(0,0,0,0.1);">
    <p>Hello {name},</p>
    <p>This is a friendly reminder about your project deadline.</p>
    <div style="background-color: #fff; padding: 15px; border-left: 4px solid #E53935; margin: 20px 0;">
      <p><strong>Project Title:</strong> {project_title}</p>
      <p><strong>Deadline:</strong> {deadline}</p>
      <p><strong>Time left:</strong> {time_left}</p>
    </div>
    <p>Please log in to your dashboard to continue and mark your progress.</p>
    <div style="text-align: center; margin: 30px 0;">
      <a href="{project_url}" style="background-color: #E53935; color: white; padding: 12px 20px; text-decoration: none; border-radius: 5px; font-weight: bold;">Open Dashboard</a>
    </div>
    <p>Best regards,<br>The ScholarlyEdge Team</p>
  </div>
  <div style="text-align: center; margin-top: 20px; color: #888; font-size: 0.8em;">
